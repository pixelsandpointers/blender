...
static void rna_def_object(BlenderRNA *brna)
{
  ...
  prop = RNA_def_property(srna, "parent_use_final_geometry", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "transflag", OB_PARENT_USE_FINAL_GEOMETRY);
  RNA_def_property_ui_text(prop,
                           "Use Final Geometry",
                           "Use the final evaluated indices rather than the original geometry");
  RNA_def_property_update(prop, NC_OBJECT | ND_DRAW, "rna_Object_internal_update");
